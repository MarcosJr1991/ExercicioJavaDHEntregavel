...
public class Aluno {
        ...
        /*O equals é um método que compara se um objeto é igual a outro. Se você não sobrescrever, é usada a implementação padrão de Object,
         que é "um objeto é igual a outro caso seja a mesma instância na memória".
          */
        /*O hashCode é um método que retorna um código hash de um objeto. Sempre que sobrescrever o equals, sobrescreva também o hashCode.
         Ele é usado normalmente para agilar a busca em collections.
          */
    }
